    ...
    return (
        <div className='mt-7'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-11/12 mx-auto'>
                ...
                <div className='space-y-8  '>
                    <div className='text-2xl flex items-center p-4 h-[100px] w-[380px]font-semibold text-gray-800   dark:text-white '>Festival Books</div>
                    <div className='text-2xl flex items-center p-4 h-[100px] w-[380px]font-semibold text-gray-800  dark:text-white '>Festival Books</div>
                    <div className='text-2xl  p-4 h-[100px] w-[380px]font-semibold text-gray-800 flex items-center  dark:text-white  '>Book Fair</div>
                    <div className='text-2xl  p-4 h-[100px] w-[380px]font-semibold text-gray-800 flex items-center  dark:text-white '>Promotion Books</div>
                </div>
                <div className='space-y-8 hidden md:block'>

                <div className='text-2xl flex items-center p-4 h-[100px] w-[380px]font-semibold text-gray-800'> 
