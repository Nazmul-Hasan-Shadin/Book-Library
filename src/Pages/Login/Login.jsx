...
<div className="hero min-h-screen  bg-base-200">
  <div className="hero-content flex-col">
    ...
    <h2 className='tect-center text-3xl'>Login</h2>
      <form onSubmit={handleLogin} className="card-body mx-auto -ml-5 ">
        ...
        <input type="submit" className='btn btn-primary   bg-gradient-to-r from-[#22c3d8] via-purple-500 to-pink-500' value={"Login"} name="" id="" />
        </div>
        <p>Or Sign In with</p>
        <div className='form-control'>
